...
def sample_card_numbers() -> List[str]:
    ...
    return [
        "7000792289606361",  # стандартный 16-значный номер
        "1234567890123456",  # другой стандартный номер
        "1234",              # короткий номер
        "12345678901234567890",  # длинный номер
        "",                   # пустая строка
        "abcd efgh ijkl mnop", # с буквами
    ]
...
def sample_account_numbers() -> List[str]:
    ...
    return [
        "73654108430135874305",  # стандартный 20-значный номер
        "1234567890",            # короткий номер
        "123456789012345678901234",  # длинный номер
        "",                       # пустая строка
        "abcd efgh ijkl mnop qrst", # с буквами
    ]
